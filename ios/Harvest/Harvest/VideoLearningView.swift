...
struct VideoLearningView: View {
    ...
    var body: some View {
        VStack(spacing: 18) {
            ...
            ScrollView { VStack(alignment: .leading, spacing: 14) { ForEach(material.segments) { Text($0.textJA).font(.system(size: DesignTokens.readingSize)).foregroundStyle(DesignTokens.ink) } }.frame(maxWidth: .infinity, alignment: .leading) }
